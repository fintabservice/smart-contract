...
const config = {
  ...
  oldContractAddress: '0x9D613a7A10CD550C7a0826c6deEcFF6f1B3e9879',//'0xe4DAf254422A18cA4C1dE729F9bd35D79f6B7497', //Ignore txs
  newAbi: JSON.parse(fs.readFileSync('./std.abi')),
  newContractAddress: '0xbD4B60a138b3fce3584EA01f50c0908c18f9677A',
  privateKey: '0x',
  gas: '150000',
  gasPrice: '12',
  fromBlock: 4358920
  ...
  for(b in balances) {
    ...
    try {
      ...
      //  nonce++;
        ...
        await helper.waitTransaction(web3, txHash, 600);
